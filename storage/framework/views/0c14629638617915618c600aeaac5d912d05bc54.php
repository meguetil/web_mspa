...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">Publicar Documento - Otras normas que atribuyen competencias</div>

                <div class="card-body">

                    <?php echo Form::open(['route'=>'sdositc.store', 'method'=>'POST',
...
<!-- /input mask -->
<?php echo $__env->make('platadmin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\web_mspa\resources\views/PlataformaPub/sec2/3/create.blade.php ENDPATH**/ ?>