...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light sticky-top flex-md-nowrap p-0 shadow">
        <div>
            <a href="{{url('/')}}" class="navbar-brand col-md-3 col-lg-2 mr-0 px-3"><img src="imgs\logo_transparencia.png" height="50"></a>
        </div>
        <div>
        ...
        <div class="sidebar-sticky pt-3 text-center">
            <ul class="nav flex-column">
                ...
                <li class="nav-item text-center">
                    <a class="nav-link text-decoration-none text-center" href="{{url('//www.municipiosanpedroatacama.cl')}}" target="_blank">
                        <h7 class="d-flex text-center">Sitio Municipalidad</h7>
                        <img class=" img-thumbnail" src="imgs/ban_logomuni.png">
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-decoration-none" href="{{url('//www.registros19862.cl')}}" target="_blank">
                ...
                <li class="nav-item">
                    <a class="nav-link text-decoration-none" href="{{url('//www.sanpedrodeatacamatransparente.cl/resources/formulario.pdf')}}" target="_blank">
                        <h7 class="d-flex">Solicitud de Información</h7>
                        <img src="imgs/ban_form.png" class="img-thumbnail">
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-decoration-none" href="{{url('//www.mercadopublico.cl/Portal/Modules/Site/Busquedas/ResultadoBusqueda.aspx?qs=1&IdEmpresa=byUkGx6fLdM=')}}" target="_blank">
                        <h7 class="d-flex">Mercado Público</h7>
                        <img src="imgs/ban_mercadopublico.png" class="img-thumbnail">
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-decoration-none" href="{{url('//www.bcn.cl/leychile/')}}" target="_blank">
                        <h7 class="d-flex">Ley Chile</h7>
                        <img src="imgs/ban_leychile.png" class="img-thumbnail">
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-decoration-none" href="{{url('//www.chileatiende.gob.cl/')}}" target="_blank">
                         <h7 class="d-flex">Chile Atiende</h7>
                         <img src="imgs/ban_ChileAtiende.jpg" class="img-thumbnail">
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-decoration-none" href="{{url('https://www.leylobby.gob.cl/instituciones/MU298')}}" target="_blank">
                        <h7 class="d-flex">Ley del Lobby</h7>
                        <img src="imgs/ban_platLoby.png" class="img-thumbnail">
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-decoration-none" href="{{url('//www.infolobby.cl/')}}" target="_blank">
            ...
            <div class="col">
                <div class="row" style="padding: 4%;">
                    <div class="card bg-light mb-3 shadow" style="width: 100%">
                        ...
                        <a href="{{Url('visor')}}" class="list-group-item list-group-item-action list-group-item-secondary">
